...
export default function DashboardLayout({ children }: PropsWithChildren) {
    ...
    const roleMenus: Record<typeof role, MenuItem[]> = {
        director: [
            ...
            { label: 'Gestión de Usuarios', href: '/usuarios' },
        ],
        soporte: [
            { label: 'Inicio', href: '/soporte/tickets' },
            { label: 'Tickets Pendientes', href: '/tickets/pendientes' },
            { label: 'Historial', href: '/tickets/historial' },
        ],
        usuario: [
            { label: 'Inicio', href: '/tickets' },
            { label: 'Abrir Ticket', href: '/tickets/crear' },
            { label: 'Mis Tickets', href: '/tickets/mios' },
        ],
    };
